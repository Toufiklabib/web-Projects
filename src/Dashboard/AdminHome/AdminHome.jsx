...
const AdminHome = () => {
  ...
  return (
    <div className='w-[900px] ml-5' >
      <CartTitle title={'Admin Home '}></CartTitle>
      <div className='mx-auto  w-30 p-5 border' >
           <Userprofile  logo={user?.photoURL} ></Userprofile>
           <h1 className='mt-2 uppercase font-bold text-center text-1xl ' >Admin NAME : {user?.displayName}</h1>
       <h1 className='mt-2  font-bold text-center text-1xl ' >Email : {user?.email}</h1>
